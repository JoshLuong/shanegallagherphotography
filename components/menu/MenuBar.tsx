...
const MenuBar = () => {
  ...
  return (
    <div className={styles.menuBar__menu}>
      <div className={styles.menuBar__menuContent} style={{ ...menuStyles }}>
      ...
      <div className={styles.menuBar__container}>
        ...
        <div className={styles.menuBar__contentContainer}>
          <div className={styles.menuBar__content}>
            <Link aria-label="Open Instagram page"className={styles.menuBar__link} href="https://www.instagram.com/shanegallagher_/" target="_blank">
            <InstagramIcon />
</Link>

            <Link aria-label="Open E-mail" className={styles.menuBar__link} href="mailto:shanegallagherphotography@gmail.com" target="_blank">
            <EmailIcon />
</Link>
          </div>
        </div>
