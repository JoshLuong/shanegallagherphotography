...
const PreviewLeftImageContent: React.FC<PreviewLeftImageContentProps> = ({
  ...
  return (
    <div className={styles.previewLeftImageContent__container}>
      <div className={styles.previewLeftImageContent__text}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
      <div className={styles.previewLeftImageContent__imagesContainer} onClick={() => onNavigate()}>
      {
        [1,2,3].map((_, index) => 
        <div key={index} className={styles.previewLeftImageContent__image}>
          <PreviewContentImage
          loaded={loaded}
          width="100%"
          ref={ref}
